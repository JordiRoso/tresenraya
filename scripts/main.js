...
//const playerClick = (ev)=> {
 ...
 //let imprimir = ev.target
 //let box11Value = ev.target.innerHTML
 //let box12Value = ev.target.innerHTML
 //let box13Value = ev.target.innerHTML
     
 
     //if (box11Value == "x")(box12Value == "x") (box13Value == "x")
    // {
         
             //imprimir.innerHTML = 'ganador x'
